let palavras = [
    "cadeira", "mesa", "televisão", "computador", "cama", "guarda roupa",
    "geladeira", "microondas", "fogão", "ventilador", "ar condicionado", "tapete",
    "vaso", "luminária", "sofá", "almofada", "cortina", "espelho",
    "escova", "pente", "celular", "câmera", "relogio", "pulseira",
    "colar", "brinco", "anel", "carro", "moto", "bicicleta",
    "avião", "navio", "trem", "ônibus", "trator", "caminhão",
    "chave", "porta", "janela", "telhado", "escada", "piscina",
    "caneta", "lápis", "borracha", "caderno", "livro", "revista",
    "jornal", "garfo", "faca", "colher", "prato", "copo",
    "vassoura", "rodo", "balde", "pano", "detergente", "sabão"
