let palavras = [
    "macarrão", "lasanha", "pizza", "hambúrguer", "sushi", "tacos",
    "panqueca", "omelete", "risoto", "paella", "tiramisu", "sorvete",
    "gelatina", "pudim", "brownie", "muffin", "cupcake", "brigadeiro",
    "pastel", "coxinha", "empada", "esfiha", "churros", "crepe",
    "waffle", "pão", "tapioca", "acarajé", "nhoque", "fondue",
    "beijinhos", "tartar", "falafel", "coxinha", "ratatouille", "quiche",
    "taco", "burrito", "nachos", "guacamole", "moussaka", "sushi"
  ];
