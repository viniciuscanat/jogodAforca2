let palavras = [
    "javascript", "python", "java", "csharp", "php", "ruby",
    "html", "css", "swift", "kotlin", "rust", "go",
    "typescript", "jquery", "react", "angular", "vue", "node",
    "express", "django", "flask", "spring", "dotnet", "rails",
    "docker", "kubernetes", "git", "github", "bitbucket", "gitlab",
    "mysql", "postgresql", "mongodb", "sqlite", "oracle", "sqlserver",
    "aws", "azure", "gcp", "heroku", "netlify", "vercel",
    "algorithm", "datastructure", "oop", "functional", "procedural", "declarative",
    "machinelearning", "datascience", "ai", "neuralnetwork", "deeplearning", "nlp"
  ];
